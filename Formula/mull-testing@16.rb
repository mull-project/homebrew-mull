class MullTestingAT16 < Formula
  ...
  on_macos do
    on_arm do
      url "https://dl.cloudsmith.io/public/mull-project/mull-testing/raw/names/mull-16/versions/0.29.0.pr1161/Mull-16-0.29.0.pr1161-LLVM-16.0.6-macOS-aarch64-15.7.4.zip"
      sha256 "f9ad272622fd7215a7fa34761b76803c6167f070403e10be6e6b0bf7e1550cc3"
    end
  end
