class MullTestingAT17 < Formula
  ...
  on_macos do
    on_arm do
      url "https://dl.cloudsmith.io/public/mull-project/mull-testing/raw/names/mull-17/versions/0.31.0.pr1170/Mull-17-0.31.0.pr1170-LLVM-17.0.6-macOS-aarch64-15.7.4.zip"
      sha256 "3806ba7f63866d9839a7237a89efb2bb7ef04c706fd7d556620614e8308cd842"
    end
  end
